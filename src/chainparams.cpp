...
public:
    CMainParams()
    {
        ...
        consensus.scryptLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        ...
        // Dual Mining
        consensus.nScryptActivationHeight = 1557500;
        consensus.lwmaAveragingWindow = 60;


        // Initialize per-algo difficulty limits
        consensus.powTypeLimits.resize(NUM_BLOCK_TYPES);
        consensus.powTypeLimits[POW_TYPE_MEOWPOW] = consensus.meowpowLimit;
        consensus.powTypeLimits[POW_TYPE_SCRYPT] = consensus.scryptLimit;
        ...
        nLWMAActivationBlock = consensus.nScryptActivationHeight; // LWMA activated at the same time as scrypt
...
public:
    CTestNetParams()
    {
        ...
        consensus.scryptLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 2016 * 60; // 1.4 days
        consensus.nPowTargetSpacing = 1 * 60;
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        ...
        // Dual Mining for testnet
        consensus.nScryptActivationHeight = 10;
        consensus.lwmaAveragingWindow = 60;
        consensus.powTypeLimits.resize(NUM_BLOCK_TYPES);
        consensus.powTypeLimits[POW_TYPE_MEOWPOW] = consensus.meowpowLimit;
        consensus.powTypeLimits[POW_TYPE_SCRYPT] = consensus.scryptLimit;
...
public:
    CRegTestParams()
    {
        ...
        // Dual Mining for regtest
        consensus.nScryptActivationHeight = 20;
        consensus.lwmaAveragingWindow = 60;
        consensus.powTypeLimits.resize(NUM_BLOCK_TYPES);
        consensus.powTypeLimits[POW_TYPE_MEOWPOW] = consensus.meowpowLimit;
        consensus.powTypeLimits[POW_TYPE_SCRYPT] = consensus.scryptLimit;
